...
#South wall
buildingData.listOfStories[0].append(Wall(pos=(500.0, 25.0), length=1000.0, angle=0.0,\
                                        wallType=buildingData.buildingSchedule.searchByType(1)))

#East wall
buildingData.listOfStories[0].append(Wall(pos=(25.0, 500.0), length=1000.0, angle=90.0,\
                                        wallType=buildingData.buildingSchedule.searchByType(1)))

#North wall
buildingData.listOfStories[0].append(Wall(pos=(975.0, 500.0), length=1000.0, angle=90.0,\
                                        wallType=buildingData.buildingSchedule.searchByType(1)))

#West wall
buildingData.listOfStories[0].append(Wall(pos=(500.0, 975.0), length=1000.0, angle=0.0, \
                                        wallType=buildingData.buildingSchedule.searchByType(1)))
